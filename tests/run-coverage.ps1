...
$units = @(
    ...
    'Atropos.Adapters.ProjectParser', 'Atropos.Adapters.ProjectContext', 'Atropos.Adapters.CompilerDependencies', 'Atropos.Adapters.CompilerContextSignature', 'Atropos.Adapters.DelphiPowerShell', 'Atropos.Adapters.CompilerTraceScript', 'Atropos.Adapters.CompilerTraceProcess', 'Atropos.Adapters.CompilerSymbols', 'Atropos.Adapters.ProjectSourceMappings', 'Atropos.Adapters.TargetAnalysisFactory', 'Atropos.Adapters.TargetResolver', 'Atropos.Adapters.ContextSyntaxBuilder', 'Atropos.Adapters.ConditionalImports', 'Atropos.Adapters.ConditionalExpression', 'Atropos.Adapters.CompilerBranchTrace', 'Atropos.Adapters.TracedIncludes', 'Atropos.Adapters.CompilerPreparation', 'Atropos.Adapters.CompilerInputs', 'Atropos.Adapters.NativeSourcePreparer', 'Atropos.Adapters.ConditionalSource', 'Atropos.Adapters.SyntaxFacts', 'Atropos.Adapters.HelperFacts', 'Atropos.Adapters.MemberReferences', 'Atropos.Adapters.SymbolFacts', 'Atropos.Adapters.ExportFacts', 'Atropos.Adapters.ImplicitEffects', 'Atropos.Adapters.SyntaxBuilder', 'Atropos.Application.TargetAnalysis', 'Atropos.Application.Logger', 'Atropos.Adapters.ProjectEvaluationScript', 'Atropos.Adapters.ReportGenerator',
