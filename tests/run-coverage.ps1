...
$units = @(
    'Atropos.Core.Domain', 'Atropos.Core.Analysis', 'Atropos.Core.AnalysisIntersection', 'Atropos.Core.Effects', 'Atropos.Core.UnitSymbols', 'Atropos.Core.HelperBinding', 'Atropos.Core.Config', 'Atropos.Core.Modifier',
